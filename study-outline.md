# IIQE 试卷一：保险原理及实务学习提纲

> 用途：面向香港保险中介人资格考试（IIQE）试卷一 / Paper 1：Principles and Practice of Insurance 的复习提纲、知识库图表与高频考点清单。  
> 提醒：考试名称、范围和监管要求可能调整；真实应考前请以官方考试手册与最新监管资料为准。
...
以下统计根据题库练习的“参考章节”整理，用于判断练习题出现频率，不等同于官方考试题数。
...
复习时使用保险投诉局的现行名称，并留意其处理个人保险合约相关金钱性质纠纷的替代纠纷解决机制定位；真实应考前请另外核对最新监管制度。
